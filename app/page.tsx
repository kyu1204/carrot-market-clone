      ...
      <div className="shadow-lgmd:flex-row flex w-full max-w-screen-sm flex-col gap-3 rounded-3xl bg-white p-5 dark:bg-gray-600">
        {["Nico", "Me", "You", "Yourself"].map((person, index) => (
          ...
          >
            ...
            <span className="text-lg font-medium empty:size-24 empty:h-5 empty:rounded-full empty:bg-gray-300 empty:animate-pulse group-hover:text-red-500">{person}</span>
